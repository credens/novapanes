// ===================================================
//      ARCHIVO shop-script.js (CON FILTROS Y BANNER DE LOGOS)
// ===================================================
...
document.addEventListener('DOMContentLoaded', function() {
    // Cargar productos, categorías y logos al mismo tiempo
    Promise.all([
...
function renderLogoScroller() {
    ...
    // Duplicamos la lista de logos para lograr el efecto de scroll infinito con CSS
...
function renderCategoryFilters() {
    ...
    // Limpiamos los filtros existentes (excepto el botón "Todos")
...
function setupEventListeners() {
    // Usamos delegación de eventos para los filtros, es más robusto
